...
// Estilos para a página de Cards (Heróis)
...
export const RelatedList = styled.FlatList.attrs({
  scrollEnabled: false,
})`
  flex-grow: 0;
`;

export const RelatedCard = styled.View`
  align-items: center;
  margin-right: 15px;
  margin-bottom: 15px;
`;
...
export const RelatedName = styled.Text`
  font-size: 12px;
  color: #333;
  text-align: center;
  width: 100px;
